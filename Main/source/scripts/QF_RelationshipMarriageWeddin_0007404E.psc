...
Actor loveInterest = Alias_LoveInterest.GetActorRef()
If loveInterest.IsInFaction(CurrentFollowerFaction)
  DialogueFollower.DismissSpecificFollower(loveInterest)
EndIf
...
Actor loveInterest = Alias_LoveInterest.GetActorRef()
If loveInterest.IsInFaction(CurrentFollowerFaction)
  DialogueFollower.DismissSpecificFollower(loveInterest, 1)
EndIf
